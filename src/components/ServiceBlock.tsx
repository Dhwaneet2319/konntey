  ...
  return (
    <section
      className={`relative overflow-hidden ${
        dark ? "bg-navy text-white pb-10" : "bg-off-white text-navy pt-20"
      }`}
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          >
            ...
            >
              <div className="bracket-corners bracket-corners-extra relative overflow-hidden border border-white/10 p-1">
                ...
                <div
                  className={`corner-cut ${
                    dark ? "corner-cut-offwhite-tl" : "corner-cut-light-tl"
                  }`}
                />
                <div
                  className={`corner-cut ${
                    dark ? "corner-cut-offwhite-br" : "corner-cut-light-br"
                  }`}
                />
              </div>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <h2
                className={`font-display text-[clamp(2.5rem,6vw,5rem)] font-black uppercase leading-display tracking-tightest ${
              ...
              <motion.div
                ...
                className={`h-[2px] w-24 origin-left ${dark ? "bg-white/30" : "bg-navy/30"}`}
              />
            </motion.div>
            ...
            >
              ...
              <div className="mt-10">
                <a
                  href="#contact"
                  className={`group inline-flex items-center gap-4 font-display text-[15px] font-black uppercase tracking-button transition-colors duration-300 ${
                    dark ? "text-gold-bright hover:text-white" : "text-navy hover:text-gold"
                  }`}
                >
