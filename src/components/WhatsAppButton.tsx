  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {showTooltip && (
          <m.div
            ...
            className="relative whitespace-nowrap bg-navy border border-gold-bright/20 px-4 py-2.5 shadow-lg shadow-black/20"
          >
      ...
      <m.a
        ...
        className="text-gold-bright drop-shadow-lg transition-all duration-300 hover:scale-110 hover:text-gold"
      >
