...
export default function BathroomRenovationsPage() {
  ...
  const serviceSchema = {
    ...
    description: "Bathroom renovations across Melbourne's western suburbs. BPC registered, AS/NZS 3740 certified waterproofing, fixed-price quotes. From small ensuite refreshes to full luxury bathroom rebuilds.",
    offers: {
      "@type": "AggregateOffer",
      lowPrice: "10000",
      highPrice: "45000",
    ...
    image: "https://www.konnteyhomerenovations.com.au/images/bathroom/hero.webp",
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Bathroom Renovations Melbourne", item: "https://www.konnteyhomerenovations.com.au/bathroom-renovations-melbourne" },
    ],
  };
  ...
  return (
    <div className="bg-white text-navy font-body hide-scrollbar min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2">
              {bathroomTypes.map((bt, i) => (
                <Reveal key={bt.title} y={20} duration={0.6} delay={i * 0.1} className="border border-navy/8 bg-white p-8">
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 lg:grid-cols-4">
              {[
                ...
                <Reveal key={img.src} y={20} duration={0.6} delay={i * 0.1} className="relative aspect-square overflow-hidden bg-navy/5">
        ...
        <section className="py-20 sm:py-28 bg-navy text-white">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-12 lg:grid-cols-2 lg:items-start">
              ...
              <Reveal x={30} y={0} className="relative h-[400px] lg:h-full min-h-[400px] w-full overflow-hidden border border-white/10">
        ...
        <RelatedContent
          serviceRoute="/bathroom-renovations-melbourne"
          serviceName="Bathroom Renovation"
          relatedGuides={[
            { label: "Bathroom renovation cost guide for Melbourne", href: "/guides/bathroom-renovation-cost-melbourne" },
        ...
        <ServiceAreasStrip service="bathroom renovations" />
      </main>
