...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Konntey Home & Renovations. How we collect, use and protect your personal information.",
};
        ...
        <div className="mt-12 space-y-10 font-body text-[16px] leading-[1.8] text-white/80">
          <section>
            ...
            <p className="mt-4">
              ...
              information collected through our website at konntey.com.au.
            </p>
          </section>
